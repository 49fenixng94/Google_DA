...
# STEP 1: COLLECT DATA
#=====================
# Upload Divvy datasets (csc files)
...
write.csv(counts, file = 'C:/Fenix/Google Data Analytics Certificate/Course_8/Case_1_Bike-Share/Working_data_R/avg_ride_length.csv')
